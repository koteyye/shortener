...
// BatchAddURL mocks base method.
func (m *MockURLStorage) BatchAddURL(arg0 context.Context, arg1 []*models.URLList, arg2 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BatchAddURL", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// BatchAddURL indicates an expected call of BatchAddURL.
func (mr *MockURLStorageMockRecorder) BatchAddURL(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BatchAddURL", reflect.TypeOf((*MockURLStorage)(nil).BatchAddURL), arg0, arg1, arg2)
}
